...
var countdownTimer = setInterval(function () {
    ...
    if (timeLeft <= 0) {
        ...
        // window.location.href = "https://telegram.me/+G5JOykjhGf42MTIx";
    }
}, 1000);
var circleElements = document.querySelectorAll('.bor1');
var colorIndex = 0;
var colors = ['#00bfff', 'black']; // Add more colors if needed
...
function redirectToLink() {
    window.location.href = "https://telegram.dog/+-nBoeM7XqQM4MWI1";
}
