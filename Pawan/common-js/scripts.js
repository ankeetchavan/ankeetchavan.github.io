	...
	if(isExists('#normal-countdown')){
		...
		$('#normal-countdown').countdown(date, function(event) {
			var $this = $(this).html(event.strftime(''
				...
				+ '<div class="time-sec"><h3 class="main-time" id="timer"></h3> <span>Secs</span></div>'));
		});
	}
...
var countdownTimer = setInterval(function () {
    ...
    if (timeLeft <= 0) {
        ...
        // window.location.href = "https://telegram.me/+hWuO7dmUUYFjOTQ1";
    }
}, 1000);
var circleElements = document.querySelectorAll('.time-sec');
var colorIndex = 0;
...
function redirectToLink() {
    window.location.href = "https://telegram.me/+GENVKihc4F40MTk1";
}